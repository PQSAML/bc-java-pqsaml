...
public interface MiscObjectIdentifiers
{
    ...
    ASN1ObjectIdentifier id_Falcon1024_ECDSA_P521_SHA512 = id_composite_signatures.branch("17"); //not in the draft
    ASN1ObjectIdentifier id_MLDSA87_ECDSA_P521_SHA512 = id_composite_signatures.branch("18"); //not in the draft
